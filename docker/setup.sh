...
python3.7 adaint/ailut_transform/setup.py sdist bdist_wheel
python3.7 -m pip install adaint/ailut_transform/dist/ailut-1.5.0-cp37-cp37m-linux_x86_64.whl